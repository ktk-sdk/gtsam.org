...
```{figure} /_static/uncertainties/lie-group-frames-residual.png
---
...
The [final post](2021-02-23-uncertainties-part3.md) will cover some final remarks regarding the conventions we defined and applications of the _adjoint_ of a Lie group, which is quite useful to properly transform covariance matrices defined for poses.
